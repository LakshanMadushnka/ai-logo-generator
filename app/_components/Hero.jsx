...
function Hero() {
  ...
  return (
    <div className='flex items-center mt-24 flex-col gap-5'>
      ...
      <h2 className='text-lg text-gray-600 text-center'>{Lookup.HeroDesc}</h2>

      <div className='flex gap-6 w-full max-w-2xl mt-10 '>
         <input placeholder={Lookup.InputTitlePlaceholder} className='p-3 border rounded-md w-full shadow-md' onChange={(event) => setLogoTitle(event?.target.value)}/>
